...
from nota.skills import base_rate, crowd_odds, liquidity, narrative, news, positioning, price_check, technicals, track_record
...
SKILLS: dict[str, tuple[SkillDefinition, Callable[..., Envelope]]] = {
    ...
    liquidity.DEFINITION.name: (liquidity.DEFINITION, liquidity.liquidity_check),
    crowd_odds.DEFINITION.name: (crowd_odds.DEFINITION, crowd_odds.crowd_odds),
}

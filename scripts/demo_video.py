...
def main() -> None:
    ...
    with sync_playwright() as p:
        ...
        page.select_option("#skill-name", "price_crosscheck")
        page.fill("#skill-args [data-arg='symbol']", "SOL")
        page.fill("#skill-args [data-arg='reference_price']", "150")
        page.click("#skill-run")
        page.wait_for_function("document.querySelector('#skill-out').textContent.length > 10", timeout=60000)
        page.locator("#skill-out").scroll_into_view_if_needed(); pause(page, 5000)

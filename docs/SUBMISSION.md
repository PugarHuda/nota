...
decision reads; the sixth, scan_market, drives the `nota scan` funnel. Track 3: five skills on
...
> Diff-first dashboard + 5 skills. https://nota-ryo.vercel.app/demo
...
>
> It's also an MCP server, so Claude Desktop or Cursor can call all five research skills directly.
>
